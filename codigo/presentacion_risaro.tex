...
\begin{figure}
	\begin{tikzpicture}
	\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[scale=0.9]{media_spring_chl_a_1998-2017_swa_sep_25x25.pdf}};
	\end{tikzpicture}
...
\begin{frame}
	...
	\begin{figure}
		\begin{tikzpicture}
		\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[scale=0.9]{std_spring_chl_a_1998-2017_swa_sep_25x25.pdf}};
		\end{tikzpicture}
...
\begin{frame}
	...
	\begin{figure}
		\begin{tikzpicture}
		\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[scale=0.9]{trend_b_anom_chl_1998-2017_swa_sep.pdf}};
		\end{tikzpicture}
...
\begin{frame}
	...
	\begin{figure}
		\begin{tikzpicture}
		\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[scale=0.45]{whiskers_plot_chl_70-55W_55-35S.pdf}};
		\end{tikzpicture}
